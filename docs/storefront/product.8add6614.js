...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"../../../libs/utils/async/index.ts":[function(require,module,exports) {
"use strict";
...
},{"retry":"../../../node_modules/retry/index.js"}],"common/constants/index.ts":[function(require,module,exports) {
"use strict";
...
var ProductPageApiService = function () {
  ...
  ProductPageApiService.prototype.loadProduct = function () {
    return __awaiter(this, void 0, void 0, function () {
      var handle, linkEl, product;
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            handle = null;

            if ((0, _common.isProductDetailsPage)() || (0, _common.isProductDetailsFromFrontpagePage)()) {
              handle = window.location.pathname.split('/').pop();
            }

            if ((0, _common.isPreviewProductsPage)()) {
              linkEl = document.querySelector('link[rel="canonical"]');
              handle = linkEl.getAttribute('href').split('/').pop();
            }

            return [4, (0, _fetch.fetchJson)('/products/' + handle + '.js', {
              retries: 3
            })];
...
},{"~../../../libs/utils/async":"../../../libs/utils/async/index.ts","~utils/common/common":"utils/common/common.ts","~utils/common/fetch":"utils/common/fetch.ts"}],"common/types.ts":[function(require,module,exports) {
"use strict";
